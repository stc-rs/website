...
export const auth = ExecutionEnvironment.canUseDOM ? firebase.auth() : undefined;
export const firestore = ExecutionEnvironment.canUseDOM ? firebase.firestore() : undefined;